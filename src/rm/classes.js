...
class Room {
    constructor(io) {
        ...
        this.incomingEvents = {
            ...
            newTimestamp: (data, client, callback) => {
            ...
            videoStateChange: (state, action = true) => {
    ...
    onNotClientEvent(cb){
        logging.debug(chalk.green("Room excluding client event callback set"))
...
class ServerVideo extends Video {
    ...
    pauseVideo(buffer, callback = true) {
